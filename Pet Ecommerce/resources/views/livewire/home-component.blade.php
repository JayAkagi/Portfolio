            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-2">
                        <h2 class="f-title">Jack Pet Supplies</h2>
                        <span class="f-subtitle">For your pet needs</span>
                        <p class="discount-code">Use Code: #FA6868</p>
                        <h4 class="s-title">Get Discount</h4>
                        <p class="s-subtitle">When visiting our store</p>
                    </div>
                </div>                
                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-3">
                        ...
                        <span class="f-subtitle">Exclusive Furniture Packages to Suit Your Pet Needs.</span>
                        <p class="sale-info">Stating at: <b class="price">$75.00</b></p>
