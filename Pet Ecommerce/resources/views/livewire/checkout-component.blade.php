<div>
    <main id="main" class="main-site">
		...
		<div class="container">
			...
			<i>(I will use stripe test card '4242424242424242' for card payment demo</i><br>
			<i>Stripe documentation = https://stripe.com/docs/testing)</i>
						...
						<div class="wrap-address-billing">
							...
							<div class="billing-address">
								...
								<p class="row-in-form">
									...
									<input type="text" name="country" value="" placeholder="Select Country" wire:model="country">
									@error('country')<span class="text-danger">{{$message}}</span>@enderror
								</p>
								<p class="row-in-form">
									<label for="country">Province / County <span>*</span></label>
									<input type="text" name="province" value="" placeholder="Select Country" wire:model="province">
									@error('province')<span class="text-danger">{{$message}}</span>@enderror
								</p>																
								<p class="row-in-form">
									<label for="city">Town / City<span>*</span></label>
									<input type="text" name="cityy" value="" placeholder="City name" wire:model="city">
					...
					<div class="col-md-12">
						<div class="wrap-address-billing">
							...
							<div class="billing-address">
								...
								<p class="row-in-form">
									<label for="country">Country<span>*</span></label>
									<input type="text" name="country" value="" placeholder="Select Country" wire:model="s_country">
									@error('s_country')<span class="text-danger">{{$message}}</span>@enderror
								</p>
								<p class="row-in-form">
									<label for="country">Province / County<span>*</span></label>
									<input type="text" name="country" value="" placeholder="Select Country" wire:model="s_province">
					...
					<div class="summary-item payment-method">
						...
						<div class="wrap-address-billing">
							...
							<p class="row-in-form">
								...
								<input type="text" name="zip-code" value="" placeholder="YY" wire:model="exp_year">
						...
						<div class="choose-payment-methods">
							...
							<label class="payment-method">
								...
								<span class="payment-desc">Experience seamless payment with our secure card payment system</span>
							</label>
							<label class="payment-method">
								<input name="payment-method" id="payment-method-paypal" value="paypal" type="radio" wire:model="paymentmode">
								<span>Paypal</span>
								<span class="payment-desc">Pay with ease using your Paypal account.</span>								
							</label>
							@error('paymentmode')<span class="text-danger">{{$message}}</span>@enderror
						</div>
						@if(Session::has('checkout'))
						<p class="summary-info grand-total"><span>Subtotal</span> <span class="grand-total-price">${{Session::get('checkout')['subtotal']}}</span></p>
						<p class="summary-info grand-total"><span>Tax</span> <span class="grand-total-price">${{Session::get('checkout')['tax']}}</span></p>
