...
<body>
    ...
    <p>We have recieved your order and thanks for shopping with us</p>
    <br/>
    ...
    <table style="width: 600px; text-align:right">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size:15px;font-weight:bold; border-top:1px solid white;">Subtotal: ${{$order->subtotal}}</td>
            </tr>
            <tr>
                <td colspan="3"></td>
