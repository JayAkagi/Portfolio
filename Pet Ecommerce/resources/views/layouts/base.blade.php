...
<head>
	...
	<title>Home</title>	
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/Staff.ico">
...
<body class="home-page home-01 ">
										...
										@if(Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="All Coupon" href="{{route('admin.contact')}}">Messages</a>
													</li>
													<li class="menu-item">
														<a title="All Coupon" href="{{route('admin.settings')}}">Settings</a>
													</li>
													<li class="menu-item">
										...
										@else
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="All Coupon" href="{{route('user.orders')}}">My Orders</a>
													</li>
													<li class="menu-item">
	...
	<script src="https://cdn.tiny.cloud/1/zmh7okzencmyetg2ae9b6345a4tv71e7ex1ratpv620sf7ra/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
